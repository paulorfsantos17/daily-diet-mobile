...
const buttonStyle = tva({
  ...
  variants: {
    action: {
      primary:
        'bg-gray-800 border-secondary-300 data-[hover=true]:bg-secondary-600 data-[hover=true]:border-secondary-400 data-[active=true]:bg-secondary-700 data-[active=true]:border-secondary-500 data-[focus-visible=true]:web:ring-indicator-info',
      positive:
...
const buttonTextStyle = tva({
  ...
  parentVariants: {
    action: {
      ...
      secondary:
        'text-[#FFF]  data-[hover=true]:text-secondary-600 data-[active=true]:text-secondary-700',
      positive:
